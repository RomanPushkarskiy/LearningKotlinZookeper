...
fun main() {
    val mutableListAnimals = mutableListOf<String>(camel, lion, deer, goose, bat, rabbit)
    ...
    var input = readln()
    while (input != "exit") {
        println(mutableListAnimals[input.toInt()])
        println("Please enter the number of the habitat you would like to view or print <exit> to close the program:")
        input = readln()
    }
